                ...
                >
                    <div className="flex flex-col justify-center place-items-center rounded-lg   md:w-[800px] md:h-[200px] mx-auto">
                        <motion.div
                            ...
                            className="w-[500px] h-[250px] sm:w-[300px] md:w-[500px] md:h-[300px]  lg:w-[700px] lg:h-[500px] xl:h-96 xl:w-full  bg-white bg-opacity-80 rounded-2xl"
                        >
                            <motion.div
                            ...
                            <motion.div
                                ...
                                dragConstraints={{ left: 0, right: 0, top: 0, bottom: 0 }}
                                whileTap={{ cursor: "grabbing" }}
                                className="absolute top-[12px] md:top-[20%] lg:top-20 xl:top-32 left-1 bg-white p-5 rounded-md shadow-2xl z-40 "
                            >
